...
#   $20 TARGET_EOS_BASE
#   $21 OUTPUT_DIR
#   $22 PROCESSING_SUB_TEMPLATE_PATH
#   $23 PROCESSING_BUNDLE_PATH
#   $24 PROCESSING_BUNDLE_NAME
#   $25 PROXY_BUNDLE_PATH
#   $26 PROXY_BUNDLE_NAME
#   $27 PROCESSING_WRAPPER_PATH
#   $28 NTUPLE_SUB_TEMPLATE_PATH
#   $29 NTUPLE_BUNDLE_PATH
#   $30 NTUPLE_BUNDLE_NAME
#   $31 NTUPLE_WRAPPER_PATH
#   $32 SUBDAG_OUTPUT_PATH
#   $33 MAX_BLOCK_SUBDAG_JOBS
#   $34 LOCAL_OUTPUT_BASE
# ==============================================================================
set -euo pipefail
...
TARGET_EOS_BASE="${20:-}"
OUTPUT_DIR="$21"
PROCESSING_SUB_TEMPLATE_PATH="$22"
PROCESSING_BUNDLE_PATH="$23"
PROCESSING_BUNDLE_NAME="$24"
PROXY_BUNDLE_PATH="$25"
PROXY_BUNDLE_NAME="$26"
PROCESSING_WRAPPER_PATH="$27"
NTUPLE_SUB_TEMPLATE_PATH="${28:-}"
NTUPLE_BUNDLE_PATH="${29:-}"
NTUPLE_BUNDLE_NAME="${30:-}"
NTUPLE_WRAPPER_PATH="${31:-}"
SUBDAG_OUTPUT_PATH="$32"
MAX_BLOCK_SUBDAG_JOBS="${33:-10}"
LOCAL_OUTPUT_BASE="${34:-}"
...
if [[ -n "${TARGET_EOS_BASE}" ]]; then
    COORD_ARGS+=(--target-eos-base "${TARGET_EOS_BASE}")
fi
